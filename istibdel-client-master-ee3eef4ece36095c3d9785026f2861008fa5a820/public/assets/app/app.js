(function () {
    var PARSE_SERVER_URL = '/parse';
    var PARSE_APP_ID = '0';
    var PARSE_MASTER_KEY = '0';
    ...
    angular.module('istibdel', ['ngResource', 'ngRoute', 'ngSanitize', 'slick','jkAngularRatingStars' , 'rzModule', 'ngMap', 'ngAutocomplete', '720kb.socialshare', 'istibdel.shared', 'istibdel.category', 'istibdel.annonce', 'istibdel.user', 'istibdel.configuration', 'istibdel.home', 'istibdel.account', 'istibdel.notification'])
        ...
        .run(['$rootScope', '$http', '$location', '$timeout','Configuration', 'User', 'Category', 'Purchase', 'Exchange', 'Comment', 'Annonce',
            function ($rootScope, $http, $location, $timeout, Configuration, User, Category, Purchase, Exchange, Comment, Annonce) {
                /* var client=(window.location.origin.indexOf('estbdl.com'))>=0;
                if(client){
                    document.location.href = '/maintenance';
                } */
                var query = new Configuration.Query();
                query.first().then(function (config) {
                    $rootScope.istibdelConfig = config;
                ...
                $http.get('/account/currentUser')
                    ...
                    .then(function (res) {
                            ...
                            query.equalTo('objectId', $rootScope.currentUser.objectId);
                ...
                // $rootScope.currentUser = {"objectId":"eB5gHpEhZT","username":"+21653704662","adresse":"Tunisia-Zarzis","fullName":"Mahmoud Lhioui","avatar":"https://istibdel.parse-server.karizma1.com/parse/files/WCfqomGyScI1LUCLmZe83XuXKCyVzdLz/fa32a8b59bae06a1177a4fb69865ebf7_profileImage.jpg","createdAt":"2017-10-15T21:02:40.662Z","updatedAt":"2017-10-23T15:17:41.389Z","isBlocked":false,"ACL":{"*":{"read":true},"eB5gHpEhZT":{"read":true,"write":true}},"__type":"Object","className":"_User"};
                ...
                var getNotif = function () {
                    ...
                    if ($rootScope.currentUser) {
                        ...
                        commentQuery.notEqualTo('confirmPurchase', true)
                            ...
                            .then(function (comments) {
                                $timeout(function () {
                                    ...
                                    $rootScope.notifCount = comments.length;
                                })
                                var query = new Annonce.Query();
                        ...
                        query.find().then(function (annonces) {
                            $timeout(function () {

                                $timeout(function () {
                                    _.each(annonces,function(item){
                                        if(item.exchangedAnnonce.length){
                                            console.log('aa');
                ...
                $rootScope.search = function (keyWord, priceMin, priceMax, categoryId, categoryParentId, country, locality) {


                    window.location.href = "/annonces/search?keyWord=" + (keyWord || '') + "&priceMin=" + (priceMin || '') + "&priceMax=" + (priceMax || '') + "&categoryId=" + (categoryId || '') + "&categoryParentId=" + (categoryParentId || '') + "&country=" + (country || '') + "&locality=" + (locality || '');
                }
                ...
                var getChilds = function (category) {
                    ...
                    query.equalTo('parent', category)
                        ...
                        .then(function (categories) {
                            ...
                            $timeout(function () {
                                $rootScope.searchCategory[category.id] = categories;
                            })
                ...
                categQuery.doesNotExist('parent')
                    ...
                    .then(function (categories) {
                        $timeout(function () {
                            $rootScope.searchCategories = categories;
                ...
                /*  */
                $rootScope.select = function (show) {
                    $timeout(function () {
                        $rootScope.show = show && !$rootScope.show;
                        $rootScope.showC = !show && !$rootScope.showC
                ...
                /* select category */
                $rootScope.selectCategory = function (parent, child) {

                    $timeout(function () {
                        $rootScope.show = !$rootScope.show
                        $rootScope.searchs.category = child;
                        $rootScope.searchs.categoryParent = parent;


                        $rootScope.categ = child || parent;
                ...
                /*  */
                /* select country */
                $rootScope.filterLocationChange = function (location, country, locality) {
                    console.log(country);
                    console.log(locality);

                    $timeout(function () {
                        $rootScope.showC = !$rootScope.showC
                        $rootScope.searchs.country = country;
                        $rootScope.searchs.locality = locality;
